...
namespace AmazingAssets.AdvancedDissolveEditor
{
    ...
    public class AdvancedDissolveGeometricCutoutControllerEditor : Editor
    {
        ...
        {
            using (new AmazingAssets.EditorGUIUtility.EditorGUILayoutBeginVertical("Box"))
            {
                ...
                if (xyzSpace.intValue == (int)AdvancedDissolve.AdvancedDissolveProperties.Cutout.Geometric.XYZSpace.World)
                {
                    ...
                    {
                        using (new AmazingAssets.EditorGUIUtility.GUIBackgroundColor(xyzPivotPointTransform.objectReferenceValue == null ? Color.yellow : Color.white))
                        {
        ...
        void DrawPlaneData(int index, SerializedProperty startPositionTransform, SerializedProperty startPosition, SerializedProperty normal)
        {
            using (new AmazingAssets.EditorGUIUtility.EditorGUILayoutBeginVertical("Box"))
            {
                using (new AmazingAssets.EditorGUIUtility.EditorGUILayoutBeginHorizontal())
                {
                    using (new AmazingAssets.EditorGUIUtility.GUIBackgroundColor(startPositionTransform.objectReferenceValue == null ? Color.yellow : Color.white))
                    {
                ...
                if (startPositionTransform.objectReferenceValue == null)
                {
                    ...
                    using (new AmazingAssets.EditorGUIUtility.GUIBackgroundColor(normal.vector3Value.magnitude == 0 ? Color.red : Color.white))
                    {
        ...
        void DrawCapsuleData(int index, SerializedProperty startPositionTransform, SerializedProperty endPositionTransform, SerializedProperty startPosition, SerializedProperty endPosition, SerializedProperty radius)
        {
            using (new AmazingAssets.EditorGUIUtility.EditorGUILayoutBeginVertical("Box"))
            {
                ...
                using (new AmazingAssets.EditorGUIUtility.EditorGUILayoutBeginHorizontal())
                {
                    using (new AmazingAssets.EditorGUIUtility.GUIBackgroundColor(endPositionTransform.objectReferenceValue == null ? Color.yellow : Color.white))
                    {
