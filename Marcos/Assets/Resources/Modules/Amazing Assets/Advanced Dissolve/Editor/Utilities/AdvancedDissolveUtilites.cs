...
namespace AmazingAssets.AdvancedDissolveEditor
{
    ...
    {
        public enum RENDER_PIPELIN { BuiltIn, Universal, HighDefinition }
        ...
        static public RENDER_PIPELIN GetProjectRenderPipeline()
        {
            if (UnityEngine.Rendering.GraphicsSettings.renderPipelineAsset == null)
                return RENDER_PIPELIN.BuiltIn;
                ...
                return RENDER_PIPELIN.Universal;
            else
                return RENDER_PIPELIN.HighDefinition;
        }
